(() => {
  'use strict';
  const BUILD_ID='20260824-26',LEGAL='Türkiye Yüzyılı Maarif Modeli dikkate alınmıştır.';
  window.LGS_ARENA_CONFIG=Object.freeze({
    ...
    coverStandard:'LGS2027-ZEUS-ARENA-COVER-2026-08-23-V630-20260824-26',coverAsset:'assets/zeus-hero-20260823-02.webp?v='+BUILD_ID,
