(() => {
  'use strict';
  const BUILD_ID='20260825-02',LEGAL='Türkiye Yüzyılı Maarif Modeli dikkate alınmıştır.';
  window.LGS_ARENA_CONFIG=Object.freeze({
    schemaVersion:14,appVersion:'8.3.0-server-authority',buildId:BUILD_ID,season:2027,appName:'LGS 2027 Arena',coverLocked:true,
