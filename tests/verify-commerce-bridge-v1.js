...
must(index.includes('arena-commerce-v1.js?v=20260825-07'),'commerce bridge is not loaded');
...
must(sw.includes('arena-edu-core-3.8.1-build-20260825-07'),'cache version mismatch');
must(manifest.includes('id=20260825-07'),'manifest build ID mismatch');
