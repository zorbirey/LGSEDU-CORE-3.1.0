...
must(index.includes('arena-account-bridge-v1.js?v=20260825-06'),'account bridge is not loaded');
must(index.includes('account-v1.css?v=20260825-06'),'account styles are not loaded');
